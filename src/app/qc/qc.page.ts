...
export class QcPage implements OnInit {
  ...
  getQCList() {
    ...
    this.HttpClient
      .get(
        this.App.api_url +"/appGetQCList/" +localStorage['token'] + "?purchase_order_id=" + this.purchase_order_id
      )
      .subscribe(
        (data: any) => { 
        //   this.loadingController.dismiss();
          this.QCList = data.result['QCList'];
          console.log("DATA",this.QCList);
