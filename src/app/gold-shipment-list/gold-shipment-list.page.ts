...
@Component({
  ...
  templateUrl: './gold-shipment-list.page.html',
  styleUrls: ['./gold-shipment-list.page.scss'],
	providers: [NativeAdapterService],
})
export class GoldShipmentListPage implements OnInit {
  ...
  getAllCustomer() {
	...
	getSupplierList() {
		...
		this.HttpClient
			.get(
				this.App.api_url + "/appGetGoldShipmentList/" + localStorage['token']
			)
			.subscribe(
				(data: any) => {
