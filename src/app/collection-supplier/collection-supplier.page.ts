...
@Component({
  ...
  templateUrl: './collection-supplier.page.html',
  styleUrls: ['./collection-supplier.page.scss'],
	providers: [NativeAdapterService],
})
export class CollectionSupplierPage implements OnInit {
  ...
  getAllCustomer() {
	...
	getSupplierList() {
		...
		this.HttpClient
			.get(
				this.App.api_url + "/appGetSupplierList/" + localStorage['token'] + "?customer_id=" + this.selectedCustomer + "&type=" + this.type
			)
			.subscribe(
				(data: any) => {
					this.isLoading = false;
					//   this.loadingController.dismiss();
					this.supplierList = data.result['customerList'];
